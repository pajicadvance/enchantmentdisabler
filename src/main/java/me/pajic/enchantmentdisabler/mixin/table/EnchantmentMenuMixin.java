...
public abstract class EnchantmentMenuMixin {
    ...
    private boolean modifyMaxTablePower(boolean original, @Local /*? fabric {*/int/*?} else {*//*float*//*?}*/ ix) {
        if (ED.CONFIG.enchantingTable.modifyMaxTablePower.get() && ix >= ED.CONFIG.enchantingTable.maxTablePower.get()) {
            return false;
        }
        return original;
    }

...
public abstract class EnchantmentMenuMixin {
    ...
    private boolean dontUpdateIfNoEnchantmentsAvailable(boolean original, @Local(name = "itemStack") ItemStack itemStack) {
    ...
    private boolean modifyMaxTablePower(boolean original, @Local(name = "bookcases") /*? fabric {*/int/*?} else {*//*float*//*?}*/ bookcases) {
    ...
    private boolean modifyLapisCostButtonClickCondition(boolean original, @Local(argsOnly = true) int id, @Local(name = "currency") ItemStack currency) {
